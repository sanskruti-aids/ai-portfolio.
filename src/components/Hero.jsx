    ...
    >
      ...
      <div className="max-w-7xl mx-auto w-full z-10 flex flex-col items-center justify-center text-center">
        ...
        <motion.div
          ...
          className="text-xl sm:text-2xl md:text-3xl font-medium text-slate-300 mb-6 h-12 flex items-center justify-center"
        >
        ...
        <motion.div
          ...
          className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12 w-full max-w-md px-4"
        >
        ...
        <motion.div
          ...
          className="text-slate-500 cursor-pointer hover:text-accent-cyan transition-colors duration-200"
        >
